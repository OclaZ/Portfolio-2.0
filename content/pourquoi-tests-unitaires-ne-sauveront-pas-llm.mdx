...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>La réponse adresse-t-elle directement la demande ?</td>
    </tr>
    <tr>
      <td><strong>Cohérence</strong></td>
      <td>Le texte est-il logique et sans contradictions ?</td>
    </tr>
    <tr>
      <td><strong>Précision factuelle</strong></td>
      <td>Les faits énoncés sont-ils vrais ?</td>
    </tr>
    <tr>
      <td><strong>Utilité</strong></td>
      <td>La réponse permet-elle à l'utilisateur d'avancer ?</td>
    </tr>
    <tr>
      <td><strong>Sécurité</strong></td>
      <td>Le contenu évite-t-il les biais ou les sorties inappropriées ?</td>
    </tr>
  </tbody>
</table>
