  ...
  <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.95rem" }}>
    <thead>
      <tr style={{ borderBottom: "2px solid #e5e7eb" }}>
        <th style={{ textAlign: "left", padding: "10px 14px", fontWeight: "700" }}>Dimension</th>
        <th style={{ textAlign: "left", padding: "10px 14px", fontWeight: "700" }}>Question clé</th>
      </tr>
    </thead>
    <tbody>
      {[
        ...
        <tr key={i} style={{ borderBottom: "1px solid #e5e7eb", backgroundColor: i % 2 === 0 ? "transparent" : "rgba(0,0,0,0.02)" }}>
          <td style={{ padding: "10px 14px", fontWeight: "600" }}>{dim}</td>
